...
def predict():
    ...
    return render_template("index.html",uploaded_image_url=url_for('static', filename='vis/' + vis_filename), prediction_image_url=url_for('static', filename='outputs/' + out_filename))
